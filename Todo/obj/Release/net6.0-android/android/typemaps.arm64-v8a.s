...
java_name_width:
	...
	.p2align	3
map_modules:
	.byte	0x9, 0x9d, 0xe8, 0xc0, 0xcc, 0xcd, 0x7, 0x44, 0xba, 0x74, 0x2a, 0x39, 0x4, 0x74, 0x3d, 0xcb	// module_uuid: c0e89d09-cdcc-4407-ba74-2a3904743dcb
	...
	.byte	0xb, 0x70, 0x51, 0xfc, 0xee, 0xd4, 0xe, 0x4e, 0xb0, 0x46, 0xff, 0xee, 0xa5, 0xc1, 0x29, 0x1b	// module_uuid: fc51700b-d4ee-4e0e-b046-ffeea5c1291b
	...
	.byte	0x85, 0x98, 0x1b, 0xd5, 0xf4, 0xd0, 0x75, 0x48, 0x9c, 0x26, 0xd8, 0xa1, 0xba, 0x99, 0xbc, 0xae	// module_uuid: d51b9885-d0f4-4875-9c26-d8a1ba99bcae
	.word	0x2	// entry_count
	.word	0x0	// duplicate_count
	.xword	.L.module17_managed_to_java	// map
	.xword	0	// duplicate_map
	.xword	map_aname.17	// assembly_name: Todo
	.xword	0x0	// image
	.word	0x0	// java_name_width
	.zero	4
	.xword	0x0	// java_map
...
map_java:
	...
	.word	0x2000012	// type_token_id
	.ascii	"crc642cfc5ea161b91bf0/MainActivity"	// java_name
	.zero	69	// byteCount == 34; fixedWidth == 103; returned size == 103
	.zero	1

	.word	0x11	// module_index
	.word	0x2000013	// type_token_id
	.ascii	"crc642cfc5ea161b91bf0/MainApplication"	// java_name
	.zero	66	// byteCount == 37; fixedWidth == 103; returned size == 103
	.zero	1
